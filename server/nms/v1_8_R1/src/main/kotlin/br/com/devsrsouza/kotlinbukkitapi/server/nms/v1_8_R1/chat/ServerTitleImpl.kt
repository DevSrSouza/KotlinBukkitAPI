...
object ServerTitleImpl : ServerTitle {
    ...
    private fun sendAnyTitle(player: Player, action: EnumTitleAction, title: String) {
    ...
    override fun sendTitle(player: Player, title: String) {
        sendAnyTitle(player, EnumTitleAction.TITLE, title)
    }

    override fun sendSubtitle(player: Player, subtitle: String) {
        sendAnyTitle(player, EnumTitleAction.SUBTITLE, subtitle)
    }
    ...
    override fun resetTitle(player: Player) {
        val packet = PacketPlayOutTitle(EnumTitleAction.RESET, null)
